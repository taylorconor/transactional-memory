...
//--------------------------------------------
TreeNode *BST::DupNode(TreeNode * T)
{
    TreeNode *dupNode;
...
//--------------------------------------------
TreeNode *BST::SearchTree(int Key)
{
...
//--------------------------------------------
int BST::Insert(TreeNode *newNode)
{
    TreeNode *temp;
    TreeNode *back;
